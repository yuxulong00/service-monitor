...
def fun_timer():
    ...
    data = {"alertType": "OVERSPEED", "currentPage": 1, "deptId": 122, "endTime": "2018-01-21 23:59:59",
            "fromOrgId": "-1", "includeChild": True, "includeSelf": True, "numPerPage": 10,
            "startTime": "2017-12-22 00:00:00", "vehicleNumber": None, "vehicleType": "-1"}

    timeBeforeRequest = time.time()  # 请求前
    r = requests.post(
        'https://www.car-day.cn/api-service/services/vehicle-alert',
